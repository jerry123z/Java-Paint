        ...
        saveMenuItem.addActionListener(           
            ...
            public void actionPerformed( ActionEvent event )
            {
                ...
                if ( result == JFileChooser.CANCEL_OPTION ) {
                    ...
                    BufferedImage image = ScreenImage.createImage(drawPanel); // create the image
                    System.out.println(fileChooser.getName());
                    try{
                        ScreenImage.writeImage(image, fileChooser.getCurrentDirectory(), fileChooser.getSelectedFile().getName());
                    }
                    catch(java.io.IOException e){
